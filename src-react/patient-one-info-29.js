...
import './patient-one-info-29.less'
import Confirm from './component/confirm/Confirm2'
import PatientCard_qd from './component/patientCard/index29'
...
export default class AddPatient extends SmartBlockComponent {
      ...
      if (idType == 2) {
        ...
        return (
          <div className="panel-msg patient-notice-msg" style={{'color':"#999",borderTop:'none',paddingTop:'0'}}>
            ...
            <p>2.您丢失就诊卡且挂失之后，此处会显示挂失状态，若非您本人挂失，请电话咨询客服。</p>
          </div>
        )
      }
  }
  ...
  render() {
    let {readOnly, birthday, cardNo,showId, cardInfo,balance, disabled, cardInfoReady,cardType,cancelText, okText, confirmCallback, display, title, des, guarderIdNo, id, idNo, idType, patientName, phoneNum, sex, isDefault, year, month, day} = this.state;
    const hideIdNo = idNo?idNo:'';
    const hideGuarderIdNo = guarderIdNo?guarderIdNo:'';
    {idType == 2 ? document.title = '儿童就诊人':document.title = '就诊人'}
    return (
      <div className="page-add-patient" id="page-add-patient">
        <div className="ui-form">
          ...
          {this.query.notCard?'':
            <PatientCard_qd cardType={cardType} 
