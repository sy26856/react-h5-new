    ...
    return (
      <div>
        <div className="pay-manner-panel">
          <Pay_qd openId={this.openId} corpId={corpId} redirect={redirect} optType={optType} patientId={patientId} price={Number(util.rmb(price / 100))} onFeeChannelChange={this.onFeeChannelChange.bind(this)} />
            {payStatus != 100 ? (
